"""
Django settings for cabapp project.
...
WSGI_APPLICATION = "cabapp.wsgi.application"
ASGI_APPLICATION = "cabapp.asgi.application"
...
if os.getenv('EMAIL_HOST_USER'):
    ...
    DEFAULT_FROM_EMAIL = f"Kokrajhar Cab <{EMAIL_HOST_USER}>"
else:
